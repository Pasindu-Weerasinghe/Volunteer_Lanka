...
<body>
  <div class="back-image" style="background-image: url(index/bg-img-login.png);">

  </div>
  <div class="container">
    <div class="item item-1">
      <img id="logo2" src="index/logo_transparent.png">
    ...
    <div class="item item-2">
      ...
      <div class="slideshow-container">
        ...
        <div class="mySlides fade">
          <img class="img" src="index/turtle.jpg">
        </div>

        <div class="mySlides fade">
          <img class="img" src="index/tree planting.jpg">
        </div>

        <div class="mySlides fade">
          <img class="img" src="index/rural schools.jpg">
        </div>
      </div>
      <br>
    </div>
  ...
  <table>
    <tr>
      <th><img class="brands" src="index/rotaract.png"></th>
      <th><img class="brands" src="index/leo.png"></th>
      <th><img class="brands" src="index/aiesec.jpg"></th>
      <th><img class="brands" src="index/lions.png"></th>
    </tr>
  </table>
