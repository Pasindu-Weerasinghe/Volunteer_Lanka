...
<div class="main" id="main">
    ...
    <div class="top-container">
        <div class="column1">
            <img class="image"
                 src="<?php echo BASE_URL ?>public/images/profile_images/<?php echo($this->profile['Photo'] ?: 'user-icon.png') ?>"/><br><br>
            <label class="sub2"> <?php echo $this->user['Name']; ?></label><br><br>
            <div class="badge"><i class="fas fa-medal <?php echo $this->color ?>-color fa-4x"></i></div>
            <br>
            <label class="sub3"><?php echo $this->badge ?></label>

        </div>
        <div class="column2"><br/>
            <button class="btnpw"><a href="<?php echo BASE_URL; ?>Volunteer/ChangeProfilePsw">Change Password</a>
            </button>
            <button class="btnpw"><a href="<?php echo BASE_URL; ?>Volunteer/change_profile">Edit</a></button>
            <br><br>
            <table>
                <tr>
                ...
                <tr>
                    ...
                    <td class="top-td"><?php foreach ($this->interests as $interest) {
                            ...
                            } else if ($interest['Interest'] == 'Environment') {
                                $text = 'Tree Planting ';
    ...
    <div class="horizontal">
        ...
        <div class="cont1">
            ...
            <label class="details">Badges earned by sending new project ideas
                : <?php echo $this->ideaBadgeCount ?></label><br><br>
            <label class="details">Total badges : <?php echo $this->totalCount ?></label><br><br>
            <div class="more"><?php echo $this->more ?> more badges to earn <?php echo $this->next ?> medal</div>
            <br>
        </div>
