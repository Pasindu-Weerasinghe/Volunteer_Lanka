...
<div id="side-menu" class="side-nav">
    ...
    <a href="<?php echo BASE_URL; ?>volunteer/my_upcoming_projects">My Upcoming Projects</a>
    <a href="<?php echo BASE_URL; ?>volunteer/my_completed_projects">My Completed Projects</a>
